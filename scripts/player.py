...
class Player():
    ...
    def __init__(self, borders):
        ...
        self.rect = pygame.Rect(30, SCALE_HEIGHT - 100, animations["idle"][0].get_width() / 4,
                                animations["idle"][0].get_height() / 2)
        ...
        self.attack_box = pygame.Rect(30 + animations["idle"][0].get_width() / 4, SCALE_HEIGHT - 100,
                                      animations["idle"][0].get_width() / 4, animations["idle"][0].get_height() / 2)
    ...
    def update(self):
        if not self.attacking and not self.rolling:
            ...
            self.attack_box.x = self.rect.x + (
                animations["idle"][0].get_width() / 4 if self.facing_right else -animations["idle"][0].get_width() / 4)
            ...
            self.rect, collisions = move(self.rect,
                                         [self.move_speed * 1.5 if self.facing_right else -self.move_speed * 1.5,
                                          self.y_momentum], self.borders)
            self.attack_box.x = self.rect.x + (
                animations["idle"][0].get_width() / 4 if self.facing_right else -animations["idle"][0].get_width() / 4)
            self.attack_box.y = self.rect.y
